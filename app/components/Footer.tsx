...
const Footer = () => {
  const footerNavs: FooterNav[] = [
    ...
    },
    {
      ...
      items: [
        {
          name: "9126 219th St, Queens Village, New York 11428, US",
        },
        {
          name: "252/3 Ka, Sher-e-Bangla Road, Khulna- 9100, Bangladesh",
        },
        {
          name: "info@softronixs.com",
        },
        {
          name: "+880 1968 696969",
        },
        {
          name: "+880 1571 744478 (Whats App)",
        },
      ],
    },
  ];
  ...
  return (
    <footer className="text-primaryWhite bg-primarySky py-5 ">
      <div className="container mx-auto">
        ...
        <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
          <div className="mt-4 sm:mt-0">
            &copy; {new Date().getFullYear()} Softronixs All rights reserved.
          </div>
            ...
            <ul className="flex items-center space-x-4">
              <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                <a href="javascript:void()">
                  <svg
                    className="svg-icon w-6 h-6 text-primaryYellow"
                    viewBox="0 0 20 20"
                  >
                    <path
                      fill="none"
              ...
              <li className="w-10 h-10 border rounded-full flex items-center justify-center">
                <a href="javascript:void()">
                  <svg
                    className="svg-icon w-6 h-6 text-primaryPurple"
                    viewBox="0 0 20 20"
                  >
                    <path
                      fill="none"
